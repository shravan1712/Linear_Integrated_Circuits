## **Aim: Design and analyze the differential amplifier for the following specifications:**
...
To find all the values of the resistor and current value. we need to solve
